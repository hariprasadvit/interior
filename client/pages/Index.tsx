          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-10">
              <div className="space-y-8">
                <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-brand-primary/10 to-blue-100 px-4 py-2 rounded-full">
                  ...
                  <span className="text-indigo-600 font-medium text-sm">
                    Rated #1 Interior Design Platform
                  </span>
                </div>
                ...
                <p className="text-xl text-brand-muted max-w-lg leading-relaxed">
                  Design your dream home with our guided 5-step process. From
                  theme selection to final payment - we make interior design
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Button
                  variant="outline"
                  className="px-10 py-4 text-lg rounded-full border-2 border-gray-300 hover:border-purple-500 hover:bg-gradient-to-r hover:from-purple-50 hover:to-blue-50 transition-all"
                >
                  View Portfolio
                </Button>
              </div>
            ...
            <div className="relative">
              <div className="relative z-10">
                <img
                  ...
                  onError={(e) => {
                    e.currentTarget.src =
                      "https://images.unsplash.com/photo-1560448204-e8207845c6d3?ixlib=rb-4.0.3&w=600&h=600&fit=crop";
                  }}
                />
      ...
      <section className="py-20 px-6 bg-white/50 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">
            {[
              {
                src: "https://images.unsplash.com/photo-1556228453-efd6c1ff04f6?ixlib=rb-4.0.3&w=300&h=300&fit=crop",
                alt: "Modern Living Room",
              },
              {
                src: "https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?ixlib=rb-4.0.3&w=300&h=300&fit=crop",
                alt: "Contemporary Kitchen",
              },
              {
                src: "https://images.unsplash.com/photo-1631679706909-1844bbd07221?ixlib=rb-4.0.3&w=300&h=300&fit=crop",
                alt: "Elegant Bedroom",
              },
              {
                src: "https://images.unsplash.com/photo-1586023492125-27b2c045efd7?ixlib=rb-4.0.3&w=300&h=300&fit=crop",
              ...
              <img
                ...
                onError={(e) => {
                  e.currentTarget.src =
                    "https://images.unsplash.com/photo-1586023492125-27b2c045efd7?ixlib=rb-4.0.3&w=300&h=300&fit=crop";
                }}
              />
            ))}
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Our streamlined process makes interior design accessible and
              stress-free
            </p>
          </div>
            ...
            {[
              {
                step: "1",
                title: "Choose BHK",
                desc: "Select your apartment size",
                icon: <Home className="h-8 w-8" />,
              },
              {
                step: "2",
                title: "Pick Style",
                desc: "Choose from 4 design themes",
                icon: <Palette className="h-8 w-8" />,
              },
              {
                step: "3",
                title: "Customize Rooms",
                desc: "Select materials for each room",
                icon: "🏠",
              },
              {
                step: "4",
                title: "Upload Plan",
                desc: "Share your floor layout",
                icon: "📐",
              },
              {
                step: "5",
                title: "Get Quote",
                desc: "Instant pricing with 5% advance",
      ...
      <footer className="bg-brand-text text-white py-16 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-300 leading-relaxed">
                Transforming spaces, creating dreams since 1998. Your trusted
                partner in interior design excellence.
              </p>
            </div>
            <div>
          ...
          <div className="border-t border-gray-700 mt-12 pt-8 text-center text-gray-400">
            <p>
              &copy; 2024 InteriorFlow. All rights reserved. Made with ❤️ in
              India.
            </p>
          </div>
        </div>
