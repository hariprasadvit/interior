...
export default function Demo() {
  const demoFeatures = [
    ...
    },
    {
      ...
      description:
        "Select from Modern, Minimalist, Traditional, or Industrial themes",
    ...
    },
    {
      ...
      description:
        "Customize materials for each room - flooring, paint, furniture, and more",
    ...
    },
    {
      ...
      description:
        "Upload your floor plans for accurate measurements and planning",
    ...
    },
    {
      ...
      description:
        "Step-by-step guidance showing project timeline and what to expect",
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-brand-muted max-w-4xl mx-auto leading-relaxed mb-8">
              This is a comprehensive demo created to showcase how we can
              digitalize and streamline the entire interior design process for
              your company. Experience the complete customer journey from
              initial selection to project completion.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center mb-16">
              ...
              <Button
                variant="outline"
                className="px-12 py-4 text-lg rounded-xl border-2 border-indigo-300 hover:border-indigo-500 hover:bg-indigo-50 transition-all"
              >
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-xl text-brand-muted mb-8 leading-relaxed">
                This demo demonstrates how we can revolutionize your interior
                design business by creating a seamless digital experience for
                your customers.
              </p>
                ...
                <Card className="shadow-xl border-0 bg-gradient-to-br from-blue-500 to-indigo-600">
                  <CardContent className="p-6 text-white text-center">
                    ...
                    <p className="text-blue-100">
                      Intelligent BHK and style matching
                    </p>
                  </CardContent>
                </Card>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Follow this guided experience to see how digital transformation
              can enhance every step of the interior design process
            </p>
          </div>
            ...
            {[
              {
                step: "1",
                title: "Choose BHK",
                desc: "Select apartment size",
                icon: "🏠",
              },
              {
                step: "2",
                title: "Pick Style",
                desc: "Choose design theme",
                icon: "🎨",
              },
              {
                step: "3",
                title: "Customize",
                desc: "Select room materials",
                icon: "⚡",
              },
              {
                step: "4",
                title: "Upload Plan",
                desc: "Share floor layout",
                icon: "📐",
              },
              {
                step: "5",
                title: "Track Progress",
                desc: "See project timeline",
                icon: "📊",
              },
            ].map((item, index) => (
      ...
      <footer className="bg-brand-text text-white py-12 px-6">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-gray-300 mb-4">
            A comprehensive demonstration of digital interior design
            transformation
          </p>
          <p className="text-gray-400 text-sm">
            © 2024 InteriorFlow. This is a demo showcasing digital interior
            design capabilities.
          </p>
        </div>
      </footer>
